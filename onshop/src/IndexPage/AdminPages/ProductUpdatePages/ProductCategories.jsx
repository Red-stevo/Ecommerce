...
const categories = [
    ...
    {categoryId:"GF5H65",categoryName:"cosmetics",categoryIcon:"https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse3.mm.bing.net%2Fth%3Fid%3DOIP.hUjsy5DqB1KkEzifTui7rgHaHa%26pid%3DApi&f=1&ipt=14cfa26ede8b62cc16846955310d8c6058fbc86c6d952a0ac9d675e3aea8cb23&ipo=images"},
    {categoryId:"GF5H65",categoryName:"Soaps",categoryIcon:"https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse3.mm.bing.net%2Fth%3Fid%3DOIP.vj7RGfg6J46iFqynBZZ9VgHaHa%26pid%3DApi&f=1&ipt=2970e2440b30206dea20f42f77e4274998f72340644f37f4471f0af1a5929bdb&ipo=images"},
]
        ...
        <div className={"product-categories-page"}>
            ...
            <section className={"product-categories-body"}>
                ...
                <div className={"product-categories-body-contents"} >
                    ...
                    <span className={"product-categories-add-category"}><GoPlus className={"plus-category"} /></span>
                </div>
